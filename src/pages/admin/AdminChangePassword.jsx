    ...
    <div style={{ marginBottom: 18 }}>
      ...
      <div style={{ position: 'relative' }}>
        <input
          ...
          style={{ paddingRight: extra ? 68 : 44 }}
...
export default function AdminChangePassword() {
  ...
  async function handleSubmit(e) {
    ...
    // Step 4: New must differ from current
  ...
  return (
    <div className="fade-in">
      <div style={{ marginBottom: 24 }}>
        ...
        <p style={{ fontSize: 14, color: '#6B7280', margin: '4px 0 0' }}>Update your admin account password</p>
      </div>
        ...
        <div style={{
          ...
          {[
            ...
            <div key={i} style={{ display: 'flex', alignItems: 'flex-start', gap: 8, marginBottom: i < 2 ? 6 : 0 }}>
              <span style={{ color: '#1B3A6B', fontSize: 14, lineHeight: 1.4 }}>•</span>
